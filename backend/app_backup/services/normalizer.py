...
def resolve_category_subcategory(
    ...
    """
    inferred_category, inferred_subcategory = infer_category_subcategory(source_text=source_text, merchant=merchant)
